...
router.post('/claim', [isAuthed, apiLimiter], async (req, res) => {
    ...
    try {
        ...
        await doTransaction(async (connection, commit) => {
            ...
            emitBalance(user.id, 'set', roundDecimal(user.balance + unclaimedEarnings));
...
router.post('/', [isAuthed, apiLimiter], async (req, res) => {
    ...
    /*
        <meta name="user-data"
          ...
          data-name="BloxRazonTest"
          data-displayName="BloxRazonTest"
    ...
    */
    ...
    try {
        ...
        await doTransaction(async (connection, commit) => {
            ...
            emitBalance(user.id, 'set', roundDecimal(user.balance + reward))
