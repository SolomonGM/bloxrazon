...
async function cacheWithdrawalCoins() {
    ...
    try {
        ...
        console.error('Error caching withdrawal coins (API key may be invalid):', e.message);
        // Set default values so the app can still start
        setTimeout(cacheWithdrawalCoins, 1000 * 60 * 5); // Retry in 5 minutes
    }
