 ...
 * Handles both number and string userId inputs
 */
...
const slackWebhooks = {
	bets: process.env.SLACK_WEBHOOK_BETS,
	highBets: process.env.SLACK_WEBHOOK_HIGH_BETS,
	robuxExchange: process.env.SLACK_WEBHOOK_ROBUX_EXCHANGE,
	cryptoDeposits: process.env.SLACK_WEBHOOK_CRYPTO_DEPOSITS,
    cryptoWithdraws: process.env.SLACK_WEBHOOK_CRYPTO_WITHDRAWS,
    cardDeposits: process.env.SLACK_WEBHOOK_CARD_DEPOSITS,
	giftCards: process.env.SLACK_WEBHOOK_GIFT_CARDS,
	market: process.env.SLACK_WEBHOOK_MARKET,
	rain: process.env.SLACK_WEBHOOK_RAIN,
	rakeback: process.env.SLACK_WEBHOOK_RAKEBACK,
	leaderboard: process.env.SLACK_WEBHOOK_LEADERBOARD,
	admin: process.env.SLACK_WEBHOOK_ADMIN,
	tips: process.env.SLACK_WEBHOOK_TIPS,
	battles: process.env.SLACK_WEBHOOK_BATTLES,
	dev: process.env.SLACK_WEBHOOK_DEV,
	promo: process.env.SLACK_WEBHOOK_PROMO,
	affiliate: process.env.SLACK_WEBHOOK_AFFILIATE,
    surveys: process.env.SLACK_WEBHOOK_SURVEYS,
    earn: process.env.SLACK_WEBHOOK_EARN
}
