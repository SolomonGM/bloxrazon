...
const { getRandomInt, hourMs, emitBalance } = require('../utils');
    ...
    try {
        ...
        await doTransaction(async (connection, commit, rollback) => {
            ...
            if (participants.length) {
                ...
                // Get updated balance for socket emission
