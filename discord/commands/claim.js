        ...
        try {
            ...
            await doTransaction(async (connection, commit) => {
                ...
                if (!user || !user.elegible) {
                    ...
                    return interaction.reply({ content: 'You have not linked your discord account to BloxRazon.com yet. You can do so in https://bloxrazon.com/profile/settings', ephemeral: true });
                }
                ...
                emitBalance(user.id, 'add', amount);
