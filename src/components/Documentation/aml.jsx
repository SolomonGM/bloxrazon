    ...
    return (
        <>
            <div class='privacy-container'>
                ...
                <div class='sections'>
                    <p>
                        BloxRazon is committed to maintaining the highest standards of integrity and compliance with all applicable laws and regulations.
                    ...
                    <div class='section'>
                        ...
                        <ol type='a'>
                            <li>Detect and prevent money laundering and terrorist financing activities on the BloxRazon platform.</li>
                    ...
                    <div class='section'>
                        ...
                        <ul>
                            <li>BloxRazon will perform adequate user identification procedures to verify the identity of its users. We will collect and maintain user information in accordance with applicable laws and regulations.</li>
                        </ul>
                    ...
                    <div class='section'>
                        ...
                        <p>
                            BloxRazon is committed to reporting suspicious transactions or activities to relevant authorities,
                    ...
                    <div class='section'>
                        ...
                        <p>
                            BloxRazon will maintain records of user identification and transaction
                    ...
                    <div className='section'>
                        ...
                        <p>
                            BloxRazon is dedicated to maintaining a secure and compliant platform for its users.
                        ...
                        <p>
                            By using BloxRazon, users agree to comply with this AML Policy and cooperate with our efforts
                            to prevent illicit activities on our platform. Failure to do so may result in account suspension or legal action,
                            as deemed appropriate.
                        </p>

                        <p>
                            For any AML-related inquiries or concerns, please contact our designated compliance officer at support@BloxRazon.com.
                        </p>
                    </div>
