        ...
        <>
            <div class='tos-container'>
                ...
                <div className='dropdown-wrapper'>
                    ...
                    <div className='dropdown'>
                        <p>
                            BloxRazon uses a system to ensure users are not exploiting the site's balance system in any
                ...
                <div className='dropdown-wrapper'>
                    ...
                    <div className='dropdown'>
                        <p>
                            BloxRazon offers a 0.5% incentive to affiliate code holders. You may also receive additional
                ...
                <div className='dropdown-wrapper'>
                    ...
                    <div className='dropdown'>
                        <p>
                            ...
                            we look for in creators. You may also email marketing@BloxRazon.com with your channel link &
                ...
                <div className='dropdown-wrapper'>
                    ...
                    <div className='dropdown'>
                        <p>
                            You can email us directly at support@BloxRazon.com or you can alternatively join our discord
                            server with the vanity URL being discord.gg/BloxRazon.
                        </p>
                    </div>
                </div>
                ...
                <div className='dropdown-wrapper'>
                    ...
                    <div className='dropdown'>
                        <p>
                            BloxRazon has a state-of-the-art provably fair system to ensure all wagers that any users
                ...
                <div className='dropdown-wrapper'>
                    ...
                    <div className='dropdown'>
                        <p>
                            BloxRazon.com uses a balance system to facilitate users withdrawals & deposits instead of an
