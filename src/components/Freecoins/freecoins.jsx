      ...
      <div class='modal' onClick={() => close()}>
        <div class='freecoins-container' onClick={(e) => e.stopPropagation()}>
          ...
          <div class='input-wrapper'>
            ...
            <div class='input'>
              <input type='text' placeholder='Code "BloxRazon" for a free 10 Robux' value={affCode()} onInput={(e) => setAffCode(e.target.value)}/>
          ...
          <div class='socials'>
            <a class='twitter' href='https://twitter.com/bloxrazoncom' target='_blank'>
            ...
            <a class='discord' href='https://discord.gg/bloxrazon' target='_blank'>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 16 12" fill="none">
            ...
            <a class='youtube' href='https://youtube.com/@bloxrazon' target='_blank'>
            ...
            <a class='twitch' href='https://twitch.tv/bloxrazon' target='_blank'>
