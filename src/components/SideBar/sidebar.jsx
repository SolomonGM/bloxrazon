    ...
    <>
      ...
      <style jsx>{`
        ...
        .logo-container {
          ...
          background: linear-gradient(277.39deg,rgba(22, 23, 33,.65) -69.8%, rgba(26, 27, 35, .65) 144.89%);
        }
        ...
        .logo-container:after {
          ...
          width: 100%;
          height: 100%;
          background: linear-gradient(to bottom right, rgba(26, 27, 35, .7), rgba(22, 23, 33, .95)), url('/assets/icons/bgsword.png');
