export const errors = {
    ...
    PASSWORD_NOT_SET: 'This account does not have a password set. Please login with your Roblox cookie.',
    ...
    ACCOUNT_AGE_AFFILIATE: "Your BloxRazon account has to be less than 30 days old to use an affiliate code.",
