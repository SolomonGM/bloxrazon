...
function Affiliates(props) {
    ...
    function copyAffLink() {
        navigator.clipboard.writeText(`https://bloxrazon.com/?a=${code()}`);
    }

    return (
        <>
            <Title>BloxRazon | Affiliates</Title>
            ...
            <div class='affiliate-container fadein'>
                <div class='affiliate-banner'>
                    ...
                    <p class='desc'>
                        INVITE PEOPLE TO BLOXRAZON TO <span class='greengradient'>EARN 10%</span> ON ALL REFERRAL WAGERS!
                    ...
                    <>
                        ...
                        <div class='settings'>
                            <div class='setting'>
                                ...
                                <p ref={linkRef}>{code() ? `https://bloxrazon.com/?a=${code()}` : `You haven't set a referral code yet!`}</p>
