...
function Coinflips(props) {
    ...
    return (
        <>
            <Title>BloxRazon | Coinflips</Title>
            <Meta name='title' content='Coinflips'></Meta>
            <Meta name='description' content='Flip Limiteds And Robux For Free On BloxRazon, Make Free Robux And Win Conflips!'></Meta>
