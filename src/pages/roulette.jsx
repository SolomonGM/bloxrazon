...
function Roulette(props) {
    ...
    return (
        <>
            <Title>BloxRazon | Roulette</Title>
            <Meta name='title' content='Roulette'></Meta>
            <Meta name='description' content='Bet On Roulette And Win Free Robux on BloxRazon! Play On Red, Green And Gold To Win 14x Multiplier'></Meta>
